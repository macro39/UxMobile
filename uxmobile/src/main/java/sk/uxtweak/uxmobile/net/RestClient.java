...
import sk.uxtweak.uxmobile.util.LongLog;
...
public class RestClient {
    ...
    private static final String HOST_BASE = "vlado5678.ynet.sk";

    private static final String HOST_WEBAPP = "";
    ...
    public void startSession(Context context, final Runnable callback) {
        ...
        Log.d("UxMobile", "API Key: " + Config.get().getApiKey());
        ...
        for (Map.Entry<String, String> entry : Config.getDeviceConfig(context).entrySet()) {
            ...
            Log.d("UxMobile", "Key: " + entry.getKey() + ", Value: " + entry.getValue());
    ...
    public void uploadEvents(final JSONArray jsonArray) {
        ...
        LongLog.d("UxMobile", "uploadEvents (session): " + Config.get().getSession());
