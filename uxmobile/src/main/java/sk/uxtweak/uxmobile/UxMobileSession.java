...
import sk.uxtweak.uxmobile.model.event.TaskEvent;
import sk.uxtweak.uxmobile.net.RestClient;
import sk.uxtweak.uxmobile.util.Config;
import sk.uxtweak.uxmobile.util.NetworkUtils;
...
//        registerShakeSensor();
    ...
    public void onFirstActivityStarted(final Activity activity) {
        Log.d("UxMobile", "onFirstActivityStarted " + activity.getComponentName().getShortClassName());
